        ...
        <tbody>
          <tr>
            <td align="center" valign="top" tex-align:"center"><br>
				<h3 style = "color: darkred;">Danh Sách Sinh Viên theo Niên Khóa</h3>
...
$sql = "SELECT id, surname_middle, first_name, year_arrival, year_commence, address, faculty, university, addition, picture FROM members where year_commence= '$year_commence' ORDER BY first_name ASC";
