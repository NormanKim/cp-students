        ...
        <tbody>
          <tr>
            ...
            <td width="274" class="text3"><a href="02-danhsach2.php">Danh sách</a></td>
			  <td width="385" class="text3"><a href="02-danhsach4.php">Liên Lạc</a></td>
...
<!-------------------------->				  
  ...
  <form action="01-delete-contact.php" method="post"><br>
	  
   <label for="lname" class="text1">Mã Số Liên Lạc:</label>
    <br>
    <input type="text" name="id"><br><br>
    
    <input type="submit" class="text2" value="Xóa Địa Chỉ"><br>
  </form>
<!-------------------------->				  
